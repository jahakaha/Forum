...
func Createpost(w http.ResponseWriter, r *http.Request) {
	...
	postView, err := pkg.NewView("bootstrap", "views/post.html")
	if err != nil {
...
func Savepost(w http.ResponseWriter, r *http.Request) {
	...
	if err := Forum.Post.WritePosttoDataBase(); err != nil {
...
func Title(w http.ResponseWriter, r *http.Request) {
	...
	articleView, err := pkg.NewView("bootstrap", "views/article.html")
	if err != nil {
