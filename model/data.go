...
// //ReadNotification reads liked and disliked posts and including my own posts : registered user
// func (f *Forum) ReadNotification(w http.ResponseWriter, r *http.Request) error {
// 	//if not logged user
// 	if !f.User.IsStatus {
// 		return nil
// 	}
